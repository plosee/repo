...
def Update():
    ...
    if Global.api == True:
        ...
        Global.TableDict2 = Global.TableDict
        Global.con = sqlite3.connect('X:/sqlite/scripts/default.db', check_same_thread=False) 
        Global.online = True
    
    # infinite loop for updating DB
    while True:
        time.sleep(5)
        ...
        if Global.TableDict != Global.TableDict2:
            ...
            if Global.online == True:
                ...
                print('DB updated with backup.', flush=True)
                
                Global.TableDict2 = Global.TableDict
                
                '''
                debug for checking if DB is updated
